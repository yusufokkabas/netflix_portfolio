  ...
  const profiles = [
    {
      name: "Recruiter",
      image: blueImage,
      backgroundGif: "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExbnFwcGRpejg4aGFlbmN1NnV1dTJubjVyd3owaDUycnhicnN1d3R5MSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2AtueHYsa0iSOyZRxc/giphy.gif" // Dark storm clouds
    },
    {
      name: "Developer",
      image: greyImage,
